...
var crypto_dto_1 = require("./crypto.dto");
...
exports.CryptoProvider = {
    ...
    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            config = configService.validate('CryptoModule', crypto_dto_1.CryptoConfig);
            return [2 /*return*/, new crypto_service_1.CryptoService(config)];
        });
    }); }
};
