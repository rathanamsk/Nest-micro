...
var auth_module_1 = require("../src/api/auth/auth.module");
var config_1 = require("../src/lib/config");
var mongoose_1 = require("../src/lib/mongoose");
describe('/POST auth/login', function () {
    var app;
    var authService = { login: function () { return ['test']; } };
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var module;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        imports: [auth_module_1.AuthModule, config_1.ConfigModule, mongoose_1.MongooseModule]
                    })
    ...
    it("login with no account", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app.getHttpServer()).post('/auth/login')];
                case 1:
                    res = _a.sent();
    ...
    it("login with incorrect password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(app.getHttpServer())
